    ...
    <div className="etymology-overlay" onClick={onClose}>
      <div className="etymology-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="etymology-content">
          ...
          <div className="etymology-section">
            <h3 className="etymology-section-title">Origin & Evolution</h3>
            <p className="etymology-explanation">{data.etymology}</p>
            <div className="etymology-scripts">
              <div className="script-item">
                <span className="script-label">Oracle Bone</span>
                <span className="script-char oracle">{data.oracleBonesScript}</span>
              </div>
              <div className="script-arrow">→</div>
              <div className="script-item">
                <span className="script-label">Seal Script</span>
                <span className="script-char seal">{data.sealScript}</span>
              </div>
              <div className="script-arrow">→</div>
              <div className="script-item">
                <span className="script-label">Modern</span>
                <span className="script-char modern">{data.character}</span>
              </div>
            </div>
          </div>
