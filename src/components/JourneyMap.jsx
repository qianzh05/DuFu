        ...
        <div className="journey-map">
          <svg viewBox="0 0 100 80" className="china-map-svg" preserveAspectRatio="xMidYMid meet">
            ...
            {journeyData.map((loc, i) => {
              ...
              const markerColor = loc.type === 'birth' ? '#4ade80' :      // Bright green
                                  loc.type === 'capital' ? '#fbbf24' :    // Bright yellow
                                  loc.type === 'death' ? '#94a3b8' :      // Light slate gray
                                  loc.highlight ? '#ef4444' :             // Bright red
                                  '#60a5fa';                              // Bright blue
              return (
                <g
                  key={loc.id}
