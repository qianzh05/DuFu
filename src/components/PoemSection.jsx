...
export const PoemSection = ({
  ...
  const handleLineClick = (lineIndex, line, event) => {
    // Check if any character in this line has etymology data
    const hasEtymology = line.split('').some(char => etymologyData[char]);
    
    if (hasEtymology) {
      // Find first character with etymology data and show it
      ...
      // No etymology available, show annotation if it exists
